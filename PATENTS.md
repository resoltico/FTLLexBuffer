...
This document provides detailed information about patent considerations for FTLLexBuffer users and contributors.

## Summary for Users

**FTLLexBuffer is licensed under the MIT License, which does not include explicit patent grant language.**
...
FTLLexBuffer implements the FTL Syntax Specification, which has different licensing from this implementation:

| Component | License | Patent Grant |
|-----------|---------|--------------|
| FTL Syntax Specification | Apache License 2.0 | Yes (explicit) |
| FTLLexBuffer (this implementation) | MIT License | No (implicit only) |
...
## What This Means for FTLLexBuffer

### For Users

**FTLLexBuffer makes no patent claims and knowingly infringes no patents.**
...
By contributing to FTLLexBuffer, you:
...
You might ask: "Why not license FTLLexBuffer under Apache 2.0 to get explicit patent grants?"
...
### Can FTLLexBuffer change to Apache 2.0?
