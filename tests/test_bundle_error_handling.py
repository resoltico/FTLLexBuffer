...
class TestBundleParseErrorWithSourcePath:
    """Test parse error WITH source_path (line 363)."""

    def test_parse_error_with_source_path_logs_error(
        self, caplog: pytest.LogCaptureFixture
    ) -> None:
        """Parse error with source_path logs error message (line 363)."""
        # NOTE: This test is a placeholder. Line 363 is hard to reach from public API
        # because add_resource doesn't expose source_path parameter to user code.
        # This would require integration testing with file system operations.
        #
        # The line is exercised through internal methods during file-based resource loading.
