...
Targets 88% → 95%+ coverage gap in src/ftllexbuffer/syntax/validator.py.
...
class TestValidatorErrorPaths:
    ...
    def test_validator_catches_or_allows_no_default_variant(self, select_expr):
        ...
        from ftllexbuffer.syntax.ast import SelectExpression  # noqa: PLC0415
...
class TestValidationResultProperties:
    ...
    def test_validation_result_valid_means_no_errors(self, resource):
        ...
        if result.is_valid:
            ...
            # (might have warnings, but those don't affect is_valid)
