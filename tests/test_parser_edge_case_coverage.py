...
from ftllexbuffer.syntax.ast import Junk, Message, Resource
...
if __name__ == "__main__":
    pytest.main([__file__, "-v", "--cov=src/ftllexbuffer/syntax/parser", "--cov-report=term-missing"])  # noqa: E501 pylint: disable=line-too-long
