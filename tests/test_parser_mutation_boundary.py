...
from ftllexbuffer.syntax.ast import Junk, Message, Pattern, Resource, SelectExpression, TextElement
...
""")
    ...
    def test_two_variants_select(self):
        ...
        """
        from ftllexbuffer.syntax.ast import Placeable  # noqa: PLC0415
