...
class TestUnknownExpressionFallback:
    ...
    def test_unknown_expression_fallback_with_mock(self) -> None:
        ...
        """
        from ftllexbuffer.runtime.resolver import FluentResolver  # noqa: PLC0415
    ...
    def test_fallback_for_all_known_expression_types(self) -> None:
        ...
        from ftllexbuffer.runtime.resolver import FluentResolver  # noqa: PLC0415
        from ftllexbuffer.syntax.ast import (  # noqa: PLC0415
            FunctionReference,
            Identifier,
            MessageReference,
            SelectExpression,
        ...
        select_expr = SelectExpression(selector=Mock(), variants=())
