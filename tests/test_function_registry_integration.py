...
class TestBuiltInFunctionsIntrospection:
    ...
    def test_built_in_functions_are_registered(self) -> None:
        """Built-in functions are registered in FUNCTION_REGISTRY."""
        assert "NUMBER" in FUNCTION_REGISTRY
        assert "DATETIME" in FUNCTION_REGISTRY
        assert "CURRENCY" in FUNCTION_REGISTRY

    def test_list_built_in_functions(self) -> None:
    ...
    def test_iterate_built_in_functions(self) -> None:
    ...
    def test_len_includes_built_in_functions(self) -> None:
        """len() includes all built-in functions."""
        count = len(FUNCTION_REGISTRY)

        assert count >= 3

    def test_get_number_function_info(self) -> None:
    ...
    def test_get_datetime_function_info(self) -> None:
        """get_function_info returns metadata for DATETIME function."""
        info = FUNCTION_REGISTRY.get_function_info("DATETIME")
    ...
    def test_get_currency_function_info(self) -> None:
        """get_function_info returns metadata for CURRENCY function."""
        info = FUNCTION_REGISTRY.get_function_info("CURRENCY")
