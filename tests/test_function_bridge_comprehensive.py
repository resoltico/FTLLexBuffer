...
from ftllexbuffer.runtime.function_bridge import (
    FluentFunction,
    FunctionRegistry,
    FunctionSignature,
)
...
class TestParameterMappingConversion:
    ...
    def test_to_snake_case_single_word(self) -> None:
        """Verify _to_snake_case handles single word."""
        result = FunctionRegistry._to_snake_case("value")
        assert result == "value"

    def test_to_snake_case_two_words(self) -> None:
        """Verify _to_snake_case handles two words."""
        result = FunctionRegistry._to_snake_case("minimumFraction")
        assert result == "minimum_fraction"

    def test_to_snake_case_multiple_words(self) -> None:
        """Verify _to_snake_case handles multiple words."""
    ...
    def test_camel_snake_roundtrip(self, snake_case: str) -> None:
        """Property: snake_case → camelCase → snake_case roundtrip."""
        ...
        back_to_snake = FunctionRegistry._to_snake_case(camel)

        assert back_to_snake == snake_case
