#!/usr/bin/env bash
# Changelog extraction script for FTLLexBuffer
#
...
if [[ $# -eq 0 ]]; then
    ...
    VERSION=$(python -c "import ftllexbuffer; print(ftllexbuffer.__version__)" 2>/dev/null)
...
echo "  https://github.com/resoltico/ftllexbuffer/releases/new?tag=v$VERSION" >&2
echo "" >&2
