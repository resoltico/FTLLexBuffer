...
|:----------|:-----|:----|:------------|
| `locale` | `str` | Y | BCP 47 locale code (e.g., "en_US", "lv_LV"). |
...
|:----------|:-----|:----|:------------|
| `message_id` | `str` | Y | Message identifier. |
| `args` | `dict[str, FluentValue] \| None` | N | Variable arguments. |
...
- Raises: `FileNotFoundError` if file missing, `OSError` on read error.
